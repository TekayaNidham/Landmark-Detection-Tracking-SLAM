...
# **Answer**: the true pose = **[x=24.12840 y=79.60200]** , final pose = **[25.497497297428197, 80.10466797303617]**
# the estimated one is somewhat very close to the true pose. However it slighly changes because of the movement and measurement noise, so the estimate will have some uncertainty. With better sensors and less noise in the measurements, we can get a better estimate.
# 
# distance : $\sqrt{(x2-x1)²+(y2-y1)² = 1.4584589472938496}$
