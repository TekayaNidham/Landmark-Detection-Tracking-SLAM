...
The project will be broken up into three Python Scripts; the first two are for exploration of provided code, and a review of SLAM architectures, **only Script 3 and the `robot_class.py` file will be graded**:
...
When you are ready to submit your project, collect all of your project files -- all executed Scripts, and python files -- and compress them into a single zip archive for upload.
